        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
          ...
          <div className="md:col-span-2">
            ...
            <div className="flex gap-4">
              <a href="#" className="size-10 bg-gray-800 hover:bg-gray-700 rounded-lg flex items-center justify-center transition-colors">
...
function CreatorCard({ name, role, github }: { name: string; role: string; github: string }) {
  return (
    <div className="bg-gray-800 rounded-lg p-4 w-64 hover:bg-gray-750 transition-colors">
      ...
      <a 
        ...
        className="flex items-center gap-2 text-gray-400 text-sm hover:text-white transition-colors mt-3"
      >
