        ...
        <section className="relative pt-32 pb-20 px-6 overflow-hidden">
            ...
            <div className="max-w-7xl mx-auto">
                <div className="text-center max-w-4xl mx-auto">
                    ...
                    <h1 className="text-5xl md:text-6xl lg:text-7xl mb-6 bg-gradient-to-r from-purple-600 via-blue-600 to-purple-600 bg-clip-text text-transparent font-bold pb-2">
                    ...
                    <div className="mb-12 w-full">
                        ...
                        <SignedOut>
                            <div className="flex flex-col items-center gap-4 bg-white/50 backdrop-blur-sm p-8 rounded-2xl border border-white/50 shadow-lg max-w-lg mx-auto">
                                <h3 className="text-xl font-semibold text-slate-900">Ready to build your portfolio?</h3>
                                <p className="text-slate-600 mb-4">Create an account to save your generated portfolios and access advanced features.</p>
                                <div className="flex gap-4">
                                    <Link href="/sign-up">
                                        <Button
                                            size="lg"
                                            className="bg-gradient-to-r from-purple-600 to-blue-600 hover:from-purple-700 hover:to-blue-700 text-lg px-8 text-white border-0"
                                        >
                                            Sign Up Free
                                    ...
                                    <Link href="/sign-in">
                                        <Button size="lg" variant="outline" className="text-lg px-8 border-slate-200 text-slate-800">
                                            Login
                                        </Button>
                                    </Link>
                                </div>
                    ...
                    <div className="flex items-center justify-center gap-6 text-sm text-gray-600">
                        ...
                        <div className="flex items-center gap-2">
                            <LucideSparkles className="size-5" />
